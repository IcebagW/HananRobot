...
public class SignupActivity extends BaseActivity  {
    ...
    public void signup() {
        ...
        String age = _emailText.getText().toString();
    ...
    public boolean validate() {
        ...
        if (age.isEmpty() ) {
            _ageText.setError("enter a valid email address");
            valid = false;
        } else {
            _ageText.setError(null);
        }
        if (sex.isEmpty() ) {
            _sexText.setError("enter a valid email address");
            valid = false;
        } else {
        ...
        if (mobile.isEmpty() || mobile.length()!=10) {
            _mobileText.setError("Enter Valid Mobile Number(10)");
            valid = false;
        } else {
